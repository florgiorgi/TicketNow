...
public class PanelInicioSesion extends JPanel {
	...
	private class PanelSuperior extends JPanel {
		...
		/**
		 * Método que inicializa la imagen segun el ancho y alto de la pantalla y la agrega al panel
		 * @param anchoPantalla
		...
		private void inicializarImagen(int anchoPantalla, int alturaPantalla) {
			...
			imagen.setIcon(new ImageIcon(PanelInicioSesion.class.getResource("/panels/logo.png")));
	...
	private class PanelCentral extends JPanel {
		...
		private void inicializarBoton() {
			...
			btnIniciarSesion.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					if (controlador.usuarioCorrecto(usuarioField.getText(), contraseñaField.getPassword())) {
						...
						JOptionPane.showMessageDialog(null, "El usuario y contraseña no coinciden. Inténtelo nuevamente.",
