...
public class PanelInformacionEspectaculo extends JPanel {
	...
	public PanelInformacionEspectaculo(Controlador controlador) {
	...
	public class PanelSuperior extends JPanel {
		...
		JLabel lblNombreDelEspectculo = new JLabel(" Nombre del espectáculo");
		...
		private void initializePanelSuperior() {
			...
			btnVolver.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					VistaTicketNow.changePanel("lista", PanelInformacionEspectaculo.this, controlador);
				}
			});
			...
			btnCarrito.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					ImageIcon icono_ticket = new ImageIcon(PanelRegistro.class.getResource("/paneles/icono-ticket.png"));
					
					SpinnerNumberModel sModel = new SpinnerNumberModel(0, 0, 30 /*Poner el maximo segun lo q hay en la bd*/, 1);
					...
					int option = optionpane.showOptionDialog(null, spinner, "Comprar entradas", JOptionPane.OK_OPTION, JOptionPane.QUESTION_MESSAGE, icono_ticket, null, null);
	...
	public class PanelCentral extends JPanel {
		...
		public PanelCentral() {
			...
			JLabel lblNewLabel_2 = new JLabel("Hoyts Unicenter");
			...
			txtrCarsEs.setText("Cars 3 es una película estadounidense de animación por ordenador en 3D, producida por Pixar Animation Studios y distribuida por Walt Disney Pictures. Es la tercera entrega de la franquicia de Cars.");
			...
			list.setModel(new AbstractListModel() {
				String[] values = new String[] {"Usuario: MariaM - Comentario: Hermosa pelicula!", "Usuario: MariaM - Comentario: Hermosa pelicula!", "Usuario: MariaM - Comentario: Hermosa pelicula!"};
				public int getSize() {
			...
			JLabel label_10 = new JLabel("4.2");
